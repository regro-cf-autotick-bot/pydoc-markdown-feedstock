...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydoc-markdown-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13607&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydoc-markdown-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydoc-markdown` can be installed with:

```
conda install pydoc-markdown
```

It is possible to list all of the versions of `pydoc-markdown` available on your platform with:
